...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	protected ConfigurableListableBeanFactory obtainFreshBeanFactory() {
		refreshBeanFactory();
		// getBeanFactory();该方法为得到Bean工厂、从GenericApplicationContext对象中来得到
		// 因为该对象在Spring环境中创建了一个Bean工厂
		// （也就是说Bean工厂的创建是由GenericApplicationContext类进行创建、所以该对象里面存在一个Bean工厂）
	...
	protected void prepareBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		...
		// 添加一个Bean的后置处理器 ApplicationContextAwareProcessor该对象实现了BeanPostProcessor
		//这里添加到BeanFactory的后置处理器是一个List
